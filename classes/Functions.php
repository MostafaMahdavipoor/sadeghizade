...
trait Functions
{
    ...
    {
        $text = "📞 <b>ارتباط مستقیم با آقای علیار صادقی‌زاده</b>\n\n" .
            "مسیر موفقیت در کنکور، نیازمند یک راهنمای باتجربه و دلسوز است.\n\n" .
            "شما می‌توانید برای دریافت <b>برنامه شخصی‌سازی شده</b>، <b>تکنیک‌های مدیریت زمان و استرس</b>، و <b>پشتیبانی مستمر</b> تا روز کنکور، مستقیماً با مشاور تخصصی، <b>آقای علیار صادقی‌زاده</b>، در ارتباط باشید.\n\n" .
            "فرصت را از دست ندهید و سوالات خود را با ایشان مطرح کنید:";

        $buttons = [
            [
                ['text' => '📩 شروع گفتگو با آقای صادقی‌زاده', 'url' => 'https://t.me/Aliyar_sadeqizadeh']
            ],
            [
                ['text' => '« بازگشت به منوی اصلی', 'callback_data' => 'go_to_main_menu']
            ]
